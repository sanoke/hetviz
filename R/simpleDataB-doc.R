#' Simple simulated data: Effect modification and no confounding
#'
...
#' \describe{
#'
#'  \item{trt}{treatment, generated from Bern(expit(0.4 \code{X5}))}
#'
...
#'  and no effect modification, \code{\link{simpleDataC}} for effect modification and
