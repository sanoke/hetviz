#' Simple simulated data: Confounding and no effect modification
#'
...
#' \describe{
#'
#'  \item{trt}{treatment, generated from Bern(expit(0.1 \code{X1} - 0.1
#'       \code{X2} + 1.1 \code{X3} - 1.1 \code{X4} + 0.4 \code{X5}))}
#'
...
#'
#'  \item{Y0}{potential outcome, generated from N(-3.85 + 5 \code{trt}
#'       + 0.5 \code{X1} - 2 \code{X2} - 0.5 \code{X3} + 2 \code{X4} + \code{X6} , 1 )
#'       where \code{trt} is set to 0}
#'
#'  \item{Y1}{potential outcome,
#'       generated from N(-3.85 + 5 \code{trt} + 0.5 \code{X1} - 2 \code{X2} - 0.5
#'       \code{X3} + 2 \code{X4} + \code{X6} , 1 ) where \code{trt} is set to 1}
#'
...
#'
#' @seealso \code{\link{simpleDataB}} for data simulated with effect modification
#'  and no confounding, \code{\link{simpleDataC}} for effect modification and
#'  confounding, and  \code{\link{simpleDataD}} for effect modification and
